...
def ResNet101():
    return ResNetAttention(Bottleneck, [3, 4, 23, 3])


def ResNet152():
    return ResNetAttention(Bottleneck, [3, 8, 36, 3])
...
class ResNetAttention(BaseModel):
    def __init__(self, block, num_blocks, num_classes=10):
        ...
        self.layer3 = self._make_layer(block, 256, num_blocks[2], stride=2)
        self.layer4 = self._make_layer(block, 512, num_blocks[3], stride=2)
        self.linear = nn.Linear(512 * 3, num_classes)

        self.transform1 = conv1x1(256, 512)
        self.transform2 = conv1x1(512, 512)
        self.transform3 = conv1x1(1024, 512)
        self.transform4 = conv1x1(2048, 512)
